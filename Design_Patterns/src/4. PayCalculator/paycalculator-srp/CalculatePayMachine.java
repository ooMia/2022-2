...
class CalculatePayMachine extends Frame implements ActionListener, DocumentListener {
    ...
    public CalculatePayMachine(EmployeeApplicationService applicationService) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == calcButton) {
            ...
            try {
                emp = applicationService.findEmployee(id);
            } catch (EmpoyeeNotFoundException exp) {
                tfIdField.setText("");
                tfWorkingHours.setText("");
                tfOvertimeHours.setText("");
            ...
            int payAmount = applicationService.calculatePayment(id, work, overTime);
        ...
        if (e.getSource() == updateButton) {
            ...
            applicationService.update(id, work, overTime);
            applicationService.printEmployees();
